        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-muted-foreground">
              Discover our curated collection of premium clothing and apparel.
              From comfortable everyday wear to stylish statement pieces, find
              the perfect items to express your personal style.
            </p>
          </div>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <main className="space-y-6">
          <div className="flex items-center justify-between">
            <h2 className="text-3xl font-bold">Clothing Collection</h2>
            <select
              value={sortOption}
